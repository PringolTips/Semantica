    ...
    public class Lexico : Token, IDisposable
    {
        ...
        private void Clasificar(int Estado)
        {
            switch (Estado)
            {
                ...
                case 12: setClasificacion(Tipos.OpFcator); break;
                ...
                case 27: setClasificacion(Tipos.OpFcator); break;
